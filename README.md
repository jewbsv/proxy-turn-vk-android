...
| **Настройки** | Потоки, DNS, капча, режим VK, обход IP/доменов, исключения приложений (ЧС/БС), шаринг обхода |
...
1. APK из [релизов](https://github.com/jewbsv/proxy-turn-vk-android/releases) или сборка ниже.
